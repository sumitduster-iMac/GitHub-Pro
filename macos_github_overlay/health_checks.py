...
def get_log_dir():
    ...
    log_dir = Path.home() / "Library" / "Logs" / "macos-github-overlay"
...
LOG_DIR = get_log_dir()
LOG_PATH = LOG_DIR / "macos_github_overlay_error_log.txt"
CRASH_COUNTER_FILE = LOG_DIR / "macos_github_overlay_crash_counter.txt"
